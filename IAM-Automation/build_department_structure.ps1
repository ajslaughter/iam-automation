...
.EXAMPLE
    ...
    PS> .\build_department_structure.ps1 -DomainDN 'DC=contoso,DC=com' -UserTemplate $userTemplate -Verbose
...
.EXAMPLE
    ...
    >> )
    PS> .\build_department_structure.ps1 -DomainDN 'DC=contoso,DC=com' -DepartmentDefinitions $departments -Credential (Get-Credential)
